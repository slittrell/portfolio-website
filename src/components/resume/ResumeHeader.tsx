    ...
    <div className="flex flex-col gap-4">
      ...
      <AnimateIn delay={100}>
        <p className="max-w-xl text-muted-foreground">
          iOS software engineer with a focus on building polished, user-centric
          mobile applications. Experienced in Swift, SwiftUI, and the broader
      ...
      <AnimateIn delay={200}>
        <div className="flex items-center gap-4 pt-2">
          ...
          <span className="text-border">|</span>
          <a
            href="https://linkedin.com/in/slittrell"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-sm text-muted-foreground transition-colors hover:text-accent"
          >
